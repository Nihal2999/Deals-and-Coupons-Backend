...
public class CouponsServiceController {
    ...
    public CouponsServiceController(CouponsService couponsServ) {
    	this.couponServ = couponsServ;
    }
   ...
   //Create Coupons by admin
    ...
    public Coupons updateCoupons(@RequestBody Coupons update) {
    	return couponServ.updateCoupons(update);
    }
